...
const Footer = () => {
  return (
    <div className='footer'>
      ...
      <p className="w-full lg:w-3/6 text-center">Course Connect is an open source course & resource aggregator from various industry experts and edtech platforms. Built for techies to aid them discover, learn, grow, and build on high quality courses and resources.</p>
